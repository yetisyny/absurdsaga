...
screen choice(items):
    ...
    vbox:
        for i in items:
            ...
            # commenting out original so that we can add the user’s choice to the history
...
#begin language_picker
                ...
                vbox:
                    ...
                    textbutton "German" text_font "DejaVuSans.ttf" action Language("german")
...
style main_menu_frame:
    ...
    # let’s just use the same file for simplicity instead
    background "gui/overlay/main_menu.png"
